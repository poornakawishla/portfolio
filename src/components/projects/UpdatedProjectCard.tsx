    ...
    <div className="bg-white dark:bg-bg-dark rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden group border border-gray-100 dark:border-text-secondary/20">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <span className="px-3 py-1 bg-white/90 dark:bg-bg-dark/90 backdrop-blur-sm rounded-full text-xs font-medium text-gray-700 dark:text-text-secondary hover:scale-110 transition-transform duration-200 capitalize">
          ...
          <div className="absolute bottom-4 right-4 flex space-x-2">
            {project.category === 'ai-images' ? (
              <>
                <button
                  onClick={() =>
                    onImagePreview && onImagePreview(project.images || [], 0)
                  }
